...
<body>
    ...
    <main class="3xl:w-full 2xl:w-[1440px] w-full h-auto  2xl:mx-auto  font-Nunito ">
        ...
        <section class="relative bg-white flex xl:flex-row flex-col-reverse gap-5 md:justify-center justify-end items-center min-h-[742px] h-screen w-full overflow-hidden lg:p-[60px] pt-28 p-5">
        ...
        <section class="flex items-center justify-center lg:p-[60px] md:p-[30px] p-3 w-full" data-aos="zoom-out">
